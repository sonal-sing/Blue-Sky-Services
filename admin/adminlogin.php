...
<body>
    ...
    <p class="text-center mt-3" style="font-size: 20px;"><i class="fa fa-user-secret text-info mr-2" aria-hidden="true"></i>Admin Area (Demo)</p>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-sm-6 col-md-4">
              <form action="" class="shadow-lg p-4 mt-4 text-info" method="POST">
                  <div class="form-group">
                  <i class="fa fa-user text-info mr-1" aria-hidden="true"></i> <label for="email" class="font-weight-bold pl-2">Email</label><input type="email" class="form-control" placeholder="Email" name="aemail">
                  <small class="form-next">We'll never share your email with anyone else.</small>
                  </div>

                  <div class="form-group mt-2">
                  <i class="fa fa-lock  text-info mr-2" aria-hidden="true"></i><label for="pass" class="font-weight-bold pl-2">Password</label><input type="password" class="form-control" placeholder="Password" name="apass">
                  </div>
